...
namespace YogaManagement_WebApp.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FormatsAvailable = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassEnd = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ClassLocationId = table.Column<int>(type: "int", nullable: false),
                    AvailableFormats = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Specialities = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Classs_ClassLocations_ClassLocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InstructorClasses_AspNetUsers_InstructorId",
                        column: x => x.InstructorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InstructorClasses_Classs_ClassId",
                        column: x => x.ClassId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Classs_ClassLocationId",
                table: "Classs",
